    ...
    return (
        ...
        <div className="min-h-screen bg-gradient-to-b from-[#004363] to-[#000000] flex items-center justify-center">
            <div className="container text-center flex flex-col gap-10 mb-20"> 
                <h1 className="text-white lg:text-7xl md:text-7xl sm:text-6xl text-4xl md:leading-[90px] sm:leading-[70px] leading-[45px] poppins-bold animate-fade-up animate-ease-in-out" >
                    <> 
                ...
                <div className="text-white md:text-3xl sm:text-1xl text-1xl animate-fade-up animate-delay-300 animate-ease-in-out">
                    Web Developer | Graphic Designer | Visual Storyteller
                </div>
                <div className="flex justify-center animate-fade-up animate-delay-450 animate-ease-in-out">
                ...
                <div className="flex justify-center animate-fade-up animate-delay-600 animate-ease-in-out">
